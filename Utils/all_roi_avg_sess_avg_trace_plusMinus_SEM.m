% all_roi_avg_sess_avg_trace_plusMinus_SEM.m
% Author: Cara
% Date: 07/06/23
...
% standard error of the mean is included to show confidence of average
...
%
% ex: all_roi_avg_sess_avg_trace_plusMinus_SEM(data_40_CA1, 40, 'CA1', CA1_colors);

function all_roi_avg_sess_avg_trace_plusMinus_SEM(data, freq, region, colors)
%% Setup
Fs = 20; %Hz
...
sem_avg = std(sess,1)./sqrt(size(sess,1));
...
saveas(gcf,['total_avg_sess_avg_trace_plusMinus_SEM_' num2str(freq), '_',region],'fig');