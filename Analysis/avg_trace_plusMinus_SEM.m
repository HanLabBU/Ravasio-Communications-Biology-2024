% avg_trace_plusMinus_SEM.m
% Author: Cara
% Date: 07/06/22
% Purpose: To make figures which show the average trace, its SEM shaded
% above and below it, and the onset and offset of stimulation.

function avg_trace_plusMinus_SEM(data40,data140,data1000, mod, region, rebound_flag, Fs, colors)
    ...
    %Ex: avg_trace_plusMinus_SEM(pos_mod_40, pos_mod_140, pos_mod_1000,'Pos', 'Hippocampus', 0, 20, colors);
