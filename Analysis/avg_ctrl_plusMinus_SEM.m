...
function avg_ctrl_plusMinus_SEM(data40,data140,data1000, data_ctrl, mod, region, rebound_flag, Fs, colors)
...
elseif rebound_flag
    ...
    saveas(gcf,[ mod '_ctrl.fig']);
    saveas(gcf,[mod '_ctrl.jpg']);
end
end