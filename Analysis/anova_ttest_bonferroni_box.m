...
function [pvals] = anova_ttest_bonferroni_box(test_struct,bcolor)
...
switch test_case
    ...
    case 3    
        ...
        % T_TEST
        [~,p] = ttest2(test_struct.CA1_40Hz, test_struct.M1_40Hz);
        pvals = p;
    ...
    case 4
        ...
        % T_TEST
        [~,p] = ttest2(test_struct.CA1_140Hz, test_struct.M1_140Hz);
        pvals = p;
    ...
    case 5
        ...
        % T_TEST
        [~,p] = ttest2(test_struct.CA1_1000Hz, test_struct.M1_1000Hz);
        pvals = p;
