% sess_compare_M1_KW.m
% Author: Cara Ravasio
% Date: 05/01/23
% Purpose: Just cleans up the waveform characterization script. Uses
% Kruskal-Wallis (dunn-sidak correction) instead of ANOVA for non-normal
% distribution

function pvals_struct = sess_compare_M1_KW(pos_40_cort,pos_140_cort,pos_1000_cort,...
