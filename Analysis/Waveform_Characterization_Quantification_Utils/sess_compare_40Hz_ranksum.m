% sess_compare_40Hz_ranksum.m
% Author: Cara Ravasio
% Date: 05/01/23
% Purpose: Just cleans up the waveform characterization script.
% Uses the Wolcoxon Ranksum test instead of t-test because it does not
% assume normal distribution.

function pvals_struct = sess_compare_40Hz_ranksum(pos_40_hip,pos_40_cort,...
