% all_roi_avg_trace_plusMinus_SEM.m
% Author: Cara
% Date: 06/28/23
...
%
% ex: all_roi_avg_trace_plusMinus_SEM(data_40_CA1, 40, 'CA1', CA1_colors);

function all_roi_avg_trace_plusMinus_SEM(data, freq, region, colors)
%% Setup
Fs = 20; %Hz
...
sem_avg = std(all_neuron,1)./sqrt(size(all_neuron,1));
...
saveas(gcf,['total_avg_trace_plusMinus_SEM_' num2str(freq), '_',region],'fig');
end
