% sess_compare_CA1_KW.m
% Author: Cara Ravasio
% Date: 05/01/23
% Purpose: Just cleans up the waveform characterization script. Uses
% Kruskal-Wallis (dunn-sidak correction) instead of ANOVA for non-normal distribution

function pvals_struct = sess_compare_CA1_KW(pos_40_hip,pos_140_hip,pos_1000_hip,...
...
[pos_inc_slope_pvals_CA1] = KW_ranksum_dunnsidak_box(inc_slope_struct,bcolor([1,3,5],:));
...
[neg_inc_slope_pvals_CA1] = KW_ranksum_dunnsidak_box(inc_slope_struct,bcolor([1,3,5],:));
ylabel('Increasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
% 
% [reb_inc_slope_pvals_CA1] = KW_ranksum_dunnsidak_box(inc_slope_struct,bcolor([1,3,5],:));
% hold on;
...
[pos_dec_slope_pvals_CA1] = KW_ranksum_dunnsidak_box(dec_slope_struct,bcolor([1,3,5],:));
...
[neg_dec_slope_pvals_CA1] = KW_ranksum_dunnsidak_box(dec_slope_struct,bcolor([1,3,5],:));
ylabel('decreasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
% 
% [reb_dec_slope_pvals_CA1] = KW_ranksum_dunnsidak_box(dec_slope_struct,bcolor([1,3,5],:));
% ylabel('decreasing Slope (df/f/Frames)');
% xlabel('Stimulation Frequency');
...
[pos_auc_pvals_CA1] = KW_ranksum_dunnsidak_box(auc_struct,bcolor([1,3,5],:));
hold on;
...
[neg_auc_pvals_CA1] = KW_ranksum_dunnsidak_box(auc_struct,bcolor([1,3,5],:));
hold on;
...
% 
% [reb_auc_pvals_CA1] = KW_ranksum_dunnsidak_box(auc_struct,bcolor([1,3,5],:));
% hold on;
...
[pos_ttp_pvals_CA1] = KW_ranksum_dunnsidak_box(ttp_struct,bcolor([1,3,5],:));
ylabel('decreasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[neg_ttp_pvals_CA1] = KW_ranksum_dunnsidak_box(ttp_struct,bcolor([1,3,5],:));
...
% 
% [reb_ttp_pvals_CA1] = KW_ranksum_dunnsidak_box(ttp_struct,bcolor([1,3,5],:));
% ylabel('ttp (df/f/Frames)');
% xlabel('Stimulation Frequency');
...
[pos_fwhm_pvals_CA1] = KW_ranksum_dunnsidak_box(fwhm_struct,bcolor([1,3,5],:));
hold on;
...
[neg_fwhm_pvals_CA1] = KW_ranksum_dunnsidak_box(fwhm_struct,bcolor([1,3,5],:));
hold on;
...
% 
% [reb_fwhm_pvals_CA1] = KW_ranksum_dunnsidak_box(fwhm_struct,bcolor([1,3,5],:));
% hold on;
...
[pos_pkht_pvals_CA1] = KW_ranksum_dunnsidak_box(pkht_struct,bcolor([1,3,5],:));
ylabel('decreasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[neg_pkht_pvals_CA1] = KW_ranksum_dunnsidak_box(pkht_struct,bcolor([1,3,5],:));
...
% 
% [reb_pkht_pvals_CA1] = KW_ranksum_dunnsidak_box(pkht_struct,bcolor([1,3,5],:));
% hold on;
...
[pos_lhs_pvals_CA1] = KW_ranksum_dunnsidak_box(lhs_struct,bcolor([1,3,5],:));
hold on;
...
[neg_lhs_pvals_CA1] = KW_ranksum_dunnsidak_box(lhs_struct,bcolor([1,3,5],:));
hold on;
...
% 
% [reb_lhs_pvals_CA1] = KW_ranksum_dunnsidak_box(lhs_struct,bcolor([1,3,5],:));
% ylabel('lhs (df/f/Frames)');
% xlabel('Stimulation Frequency');
...
[pos_rhs_pvals_CA1] = KW_ranksum_dunnsidak_box(rhs_struct,bcolor([1,3,5],:));
ylabel('decreasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[neg_rhs_pvals_CA1] = KW_ranksum_dunnsidak_box(rhs_struct,bcolor([1,3,5],:));
...
% 
% [reb_rhs_pvals_CA1] = KW_ranksum_dunnsidak_box(rhs_struct,bcolor([1,3,5],:));
% ylabel('rhs (df/f/Frames)');
% xlabel('Stimulation Frequency');
