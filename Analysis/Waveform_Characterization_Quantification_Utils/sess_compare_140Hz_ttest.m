%sess_compare_140Hz_ttest.m
% Author: Cara Ravasio
% Date: 04/18/23
% Purpose: Just cleans up the waveform characterization script.

function pvals_struct = sess_compare_140Hz_ttest(pos_140_hip,pos_140_cort,...
...
[pos_inc_slope_pvals_140] = anova_ttest_bonferroni_box(inc_slope_struct,bcolor([3,4],:));
...
[neg_inc_slope_pvals_140] = anova_ttest_bonferroni_box(inc_slope_struct,bcolor([3,4],:));
ylabel('Increasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[reb_inc_slope_pvals_140] = anova_ttest_bonferroni_box(inc_slope_struct,bcolor([3,4],:));
hold on;
...
[pos_dec_slope_pvals_140] = anova_ttest_bonferroni_box(dec_slope_struct,bcolor([3,4],:));
...
[neg_dec_slope_pvals_140] = anova_ttest_bonferroni_box(dec_slope_struct,bcolor([3,4],:));
ylabel('decreasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[reb_dec_slope_pvals_140] = anova_ttest_bonferroni_box(dec_slope_struct,bcolor([3,4],:));
ylabel('decreasing Slope (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[pos_auc_pvals_140] = anova_ttest_bonferroni_box(auc_struct,bcolor([3,4],:));
...
[neg_auc_pvals_140] = anova_ttest_bonferroni_box(auc_struct,bcolor([3,4],:));
ylabel('AUC (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[reb_auc_pvals_140] = anova_ttest_bonferroni_box(auc_struct,bcolor([3,4],:));
ylabel('AUC (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[pos_ttp_pvals_140] = anova_ttest_bonferroni_box(ttp_struct,bcolor([3,4],:));
...
[neg_ttp_pvals_140] = anova_ttest_bonferroni_box(ttp_struct,bcolor([3,4],:));
ylabel('ttp (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[reb_ttp_pvals_140] = anova_ttest_bonferroni_box(ttp_struct,bcolor([3,4],:));
ylabel('ttp (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[pos_fwhm_pvals_140] = anova_ttest_bonferroni_box(fwhm_struct,bcolor([3,4],:));
hold on;
...
[neg_fwhm_pvals_140] = anova_ttest_bonferroni_box(fwhm_struct,bcolor([3,4],:));
hold on;
...
[reb_fwhm_pvals_140] = anova_ttest_bonferroni_box(fwhm_struct,bcolor([3,4],:));
hold on;
...
[pos_pkht_pvals_140] = anova_ttest_bonferroni_box(pkht_struct,bcolor([3,4],:));
...
[neg_pkht_pvals_140] = anova_ttest_bonferroni_box(pkht_struct,bcolor([3,4],:));
ylabel('pkht (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[reb_pkht_pvals_140] = anova_ttest_bonferroni_box(pkht_struct,bcolor([3,4],:));
hold on;
...
[pos_lhs_pvals_140] = anova_ttest_bonferroni_box(lhs_struct,bcolor([3,4],:));
hold on;
...
[neg_lhs_pvals_140] = anova_ttest_bonferroni_box(lhs_struct,bcolor([3,4],:));
hold on;
...
[reb_lhs_pvals_140] = anova_ttest_bonferroni_box(lhs_struct,bcolor([3,4],:));
ylabel('lhs (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[pos_rhs_pvals_140] = anova_ttest_bonferroni_box(rhs_struct,bcolor([3,4],:));
...
[neg_rhs_pvals_140] = anova_ttest_bonferroni_box(rhs_struct,bcolor([3,4],:));
ylabel('rhs (df/f/Frames)');
xlabel('Stimulation Frequency');
...
[reb_rhs_pvals_140] = anova_ttest_bonferroni_box(rhs_struct,bcolor([3,4],:));
ylabel('rhs (df/f/Frames)');
xlabel('Stimulation Frequency');
